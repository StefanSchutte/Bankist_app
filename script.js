...
*/
//197 the intersection observer api
/*
...
const stickyNav = function (entries) {
  ...
  if (!entry.isIntersectiong) nav.classList.add('sticky');
  else nav.classList.remove('sticky');
};
...
*/
/*
//189 TYPES OF EVENTS AND EVENT HANDELERS
...
h1.closest('.header').style.backgroud = 'var(--gradient-secondary)';

h1.closest('h1').style.backgroud = 'var(--gradient-primary)';
